		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Routing app",
									"targetURL": "#comsaprouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaprouting-display": {
								"semanticObject": "comsaprouting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.routing",
									"url": sap.ui.require.toUrl("com/sap/routing")
								}
							}
						}
					}
